...
| `cryptography_suite.symmetric`, `cryptography_suite.asymmetric`, `cryptography_suite.protocols`, `cryptography_suite.pipeline` | Core examples with deprecations | Existing helpers generally follow SemVer; deprecations should remain functional for **two minor releases** before removal when practical. |
