...
async def encrypt_file_async(
    ...
    :func:`encrypt_file` while performing non-blocking I/O and processing
    the input in bounded chunks.
    """
...
async def decrypt_file_async(
    ...
    Uses a password-derived key and supports both the current versioned file
    format and legacy ``salt || nonce || ciphertext_and_tag`` files.
    """
